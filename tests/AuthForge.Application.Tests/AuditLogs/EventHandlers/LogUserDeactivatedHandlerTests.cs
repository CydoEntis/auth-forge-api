...
public class LogUserDeactivatedHandlerTests
{
    private readonly Mock<IAuditLogRepository> _auditLogRepositoryMock;
    private readonly Mock<IEndUserRepository> _endUserRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<ICurrentUserService> _currentUserServiceMock;
    private readonly LogUserDeactivatedHandler _handler;

    public LogUserDeactivatedHandlerTests()
    {
        ...
        _handler = new LogUserDeactivatedHandler(
    ...
    public async Task Handle_WithValidEvent_ShouldCreateAuditLog()
    {
        ...
        var domainEvent = new EndUserDeactivatedDomainEvent(userId, applicationId);
    ...
    public async Task Handle_ShouldSerializeEventDetailsCorrectly()
    {
        ...
        capturedAuditLog!.EventType.Should().Be(AuditEventConstants.UserDeactivated);
    }
