...
public class LogPasswordResetRequestedHandlerTests
{
    ...
    public async Task Handle_WithValidEvent_ShouldCreateAuditLog()
    {
        ...
        var domainEvent = new EndUserPasswordResetRequestedDomainEvent(userId);
    ...
    public async Task Handle_ShouldSetCorrectEventType()
    {
        ...
        // ASSERT
        capturedAuditLog!.EventType.Should().Be(AuditEventConstants.PasswordResetRequested);
    }
}
