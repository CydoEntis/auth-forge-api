...
public class LogUserActivatedHandlerTests
{
    private readonly Mock<IAuditLogRepository> _auditLogRepositoryMock;
    private readonly Mock<IEndUserRepository> _endUserRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<ICurrentUserService> _currentUserServiceMock;
    private readonly LogUserActivatedHandler _handler;

    public LogUserActivatedHandlerTests()
    {
        ...
        _handler = new LogUserActivatedHandler(
    ...
    public async Task Handle_WithValidEvent_ShouldCreateAuditLog()
    {
        ...
        var domainEvent = new EndUserActivatedDomainEvent(userId, applicationId);
    ...
    public async Task Handle_ShouldSetCorrectEventType()
    {
        ...
        // ASSERT
        capturedAuditLog!.EventType.Should().Be(AuditEventConstants.UserActivated);
    }
}
