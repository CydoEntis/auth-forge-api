...
namespace AuthForge.Infrastructure.Migrations
{
    ...
    [Migration("20251104001735_AddEncryptionAndOAuthToApplications")]
    partial class AddEncryptionAndOAuthToApplications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuthForge.Domain.Entities.Application", b =>
                {
                    ...
                    b.OwnsOne("AuthForge.Domain.ValueObjects.OAuthSettings", "OAuthSettings", b1 =>
                        {
                            b1.Property<Guid>("ApplicationId")
                                .HasColumnType("TEXT");

                            b1.Property<string>("GithubClientId")
                                .HasMaxLength(255)
                                .HasColumnType("TEXT")
                                .HasColumnName("oauth_github_client_id");

                            b1.Property<string>("GithubClientSecret")
                                .HasMaxLength(500)
                                .HasColumnType("TEXT")
                                .HasColumnName("oauth_github_client_secret");

                            b1.Property<bool>("GithubEnabled")
                                .HasColumnType("INTEGER")
                            ...
                            b1.Property<string>("GoogleClientSecret")
                                .HasMaxLength(500)
                                .HasColumnType("TEXT")
                                .HasColumnName("oauth_google_client_secret");

                            b1.Property<bool>("GoogleEnabled")
                                .HasColumnType("INTEGER")
