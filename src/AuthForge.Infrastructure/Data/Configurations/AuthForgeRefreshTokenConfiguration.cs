...
public class AuthForgeRefreshTokenConfiguration : IEntityTypeConfiguration<AuthForgeRefreshToken>
{
    public void Configure(EntityTypeBuilder<AuthForgeRefreshToken> builder)
    {
        builder.ToTable("authforge_refresh_tokens");
