...
public class ConfigureApplicationEmailSettingsCommandValidator : AbstractValidator<ConfigureApplicationEmailSettingsCommand>
{
    public ConfigureApplicationEmailSettingsCommandValidator()
    {
