...
public sealed class LogPasswordChangedHandler 
    : INotificationHandler<EndUserPasswordChangedDomainEvent>
{
    private readonly IAuditLogRepository _auditLogRepository;
    private readonly IEndUserRepository _endUserRepository;
    private readonly IUnitOfWork _unitOfWork;

    public LogPasswordChangedHandler(
    ...
    public async ValueTask Handle(
        EndUserPasswordChangedDomainEvent notification,
        CancellationToken cancellationToken)
    {
        ...
        var auditLog = AuditLog.Create(
            user.ApplicationId,
            AuditEventConstants.PasswordChanged,
            user.Email.Value,
