...
public sealed class EndUserRefreshToken : AggregateRoot<Guid>
{
    private EndUserRefreshToken()
    {
    }
        ...
        string? userAgent = null)
    {
        ...
        return new EndUserRefreshToken(
            Guid.NewGuid(),
            userId,
            token,
            expiresAtUtc,
    ...
    public void Revoke(string? replacedByToken = null)
    {
        ...
        RaiseDomainEvent(new EndUserRefreshTokenRevokedDomainEvent(UserId, Token));
    }
