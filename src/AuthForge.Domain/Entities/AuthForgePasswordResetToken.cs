...
public sealed class AuthForgePasswordResetToken : Entity<Guid>
{
    private AuthForgePasswordResetToken()
    {
    }
    ...
    public static AuthForgePasswordResetToken Create(
        AuthForgeUserId userId,
        int expirationHours = 1)
    {
        ...
        return new AuthForgePasswordResetToken(
            Guid.NewGuid(),
            userId,
            token,
            expiresAt);
