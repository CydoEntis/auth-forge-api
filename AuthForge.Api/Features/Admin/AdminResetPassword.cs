...
public sealed class AdminResetPasswordValidator
    : AbstractValidator<AdminResetPasswordRequest>
{
    ...
    public static void MapEndpoints(WebApplication app, string prefix = "/api/v1")
    {
        app.MapPost($"{prefix}/reset-password", async (
                ...
                CancellationToken ct) =>
            {
                ...
                return Results.Ok(ApiResponse<AdminResetPasswordResponse>.Ok(response));
            })
